...
Perhaps the most mature tool is persistent homology, which summarizes multiscale topological information in a two-dimensional persistence diagram (see Figure \ref{fig:persistence_diagram} and Chapter \ref{ch:background}).
