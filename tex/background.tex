...
Stability result determine how a change in $D\rightarrow D'$ takes us to $H\rightarrow H'$.
...
Persistent homology says that short bars are topological noise.
Can this statement be made precise?
How short is short?
How does noisy sampling effect the observed diagram?
What is needed to confidently interpret the persistence diagram of a finite sample of a topological space as a reflection of the true topology?
Substantial recent work in the TDA community has fcoused on these questions in order to develop statistical foundations for persistent homology.
We give here a flavor of some of these results, and their relation to our own work.

Fasy and coauthors have developed ways of generating confidence intervals for persistence diagrams.
...
Bubenik has developed the language of persistence landscapes, whereby multiple persistence diagrams can be 
